...
func TestClassify_UserMessage(t *testing.T) {
	...
	assert.Equal(t, interfaces.EventTypeUserMessage, rows[0].EventType)
...
func TestClassify_AgentResponse(t *testing.T) {
	...
	require.Len(t, rows, 1)
	assert.Equal(t, interfaces.EventTypeLLMResponse, rows[0].EventType)
...
func TestClassify_ToolCallAndResult(t *testing.T) {
	...
	require.Len(t, rows, 1)
	assert.Equal(t, interfaces.EventTypeToolCall, rows[0].EventType)
	...
	require.Len(t, rows, 1)
	assert.Equal(t, interfaces.EventTypeToolResult, rows[0].EventType)
